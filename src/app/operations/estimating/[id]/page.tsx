      ...
      <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border rounded-2xl p-5 space-y-3">
            <div className="flex flex-wrap justify-between gap-3">
              ...
              <div className="text-sm text-slate-600 text-right">
                ...
                <div className="capitalize">{estimate.pricingMode.replace("_", " ")}</div>
              </div>
            </div>
            ...
            <div className="bg-white border rounded-2xl p-5">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex justify-between text-teal">
                  ...
                  <span>
                    {money(priced.grossMargin)} ({priced.grossMarginPct.toFixed(1)}%)
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="bg-white border rounded-2xl p-5 space-y-3 text-sm">
          ...
          <Link
            ...
            className="inline-block text-teal hover:underline pt-2"
          >
            New estimate →
          </Link>
        </div>
